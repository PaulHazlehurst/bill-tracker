...
import { LayoutDashboard, Users2, Activity, Settings, FileText, Search, Landmark, GitBranch, ClipboardList } from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
  ...
  { type: "nav", label: "Legislators", href: "/legislators", icon: Landmark },
